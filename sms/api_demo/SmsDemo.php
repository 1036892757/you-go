...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4GFmBMTaMfd53hJaRzZn"; // AccessKeyId

        $accessKeySecret = "uq7roB2V0WSB0s3oTfbAO5ujucoaye"; // AccessKeySecret
     ...
     */
     public static function sendSms($phoneNumber) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($phoneNumber);  //从前端获取手机号

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("千峰验证");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_190272483");
